...
var textosHabilidades = [
    "Excelente mobilidade e uma grande força para causar dano de forma rápida. Em contrapartida, esses Campeões podem ser mortos com a mesma velocidade em que são capazes de causar dano.",
    "Campeões capazes de lançar feitiços mágicos para atrapalhar os inimigos. Suas defesas não são das melhores.",
    "Personagens capazes de agradar diversos tipos de jogadores. Atuam bem tanto no ataque, como também na defesa. Seus ataques são de curta distância, mas essa exposição ao perigo é compensada com uma boa dose de pontos de resistência.",
    "Causam muito dano sem ficar cara a cara com o perigo. Além da alta capacidade de “machucar” o inimigo, os Atiradores ajudam bastante na hora de detonar com alvos importantes do mapa. Entretanto são frágeis e precisam estar sempre protegidos pelo seu time.",
    ...
    "São utilizados mais como ferramenta de controle do que para causar grandes danos nos inimigos, pois têm uma boa base defensiva, ajudando em situações específicas dentro da partida. Em compensação, sua mobilidade é baixa."
];
